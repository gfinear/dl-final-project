...
class Encoder(object):
    ...
    def __init__(self, model, prep=False):
      self._model = model
      self.prep = prep
    ...
    def encode(self, X, use_norm=True, verbose=True, batch_size=128, use_eos=False):
      ...
      """
      return encode(self._model, X, use_norm, verbose, batch_size, use_eos, self.prep)


def encode(model, X, use_norm=True, verbose=True, batch_size=128, use_eos=False, prep=False):
    """
    Encode sentences in the list X. Each entry will return a vector
    """
